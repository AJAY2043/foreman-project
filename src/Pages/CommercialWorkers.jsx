...
const CommercialWorkers = () => {
  ...
  const getUniqueLocations = () => {
    const locations = workerData.workers.map(worker => worker.address);
    return [...new Set(locations)];
  };

  // Filter workers based on the selected location
